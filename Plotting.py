...
Result=pickle.load(open("C:/Users/310122653/Documents/PhD/Article_4_(MMC)/Results/4_All_MMCcECG_deep_LSTM.pkl", "rb") )
...
XAxse= range(len(Result.mean_train_loss_overall))
mean_train_metric=Result.mean_train_metric_overall.T
mean_val_metric=Result.mean_val_metric_overall
mean_train_loss=Result.mean_train_loss_overall
mean_val_loss=Result.mean_val_loss_overall

#XAxse= range(len(Result.mean_train_loss))

mean_train_metric_all=np.asarray(Result.mean_train_metric)
mean_val_metric_all=Result.mean_val_metric
mean_train_loss_all=Result.mean_train_loss
mean_val_loss_all=Result.mean_val_loss
