...
def inputcombinations2(whatID):
    ...
    if whatID in np.arange(800,807) or whatID in np.arange(824,830):
...
#%% Residual on bi-states 400-441
    ...
    if whatID in np.arange(400,437,6) or whatID in np.arange(700,737,6) or whatID in [824]:
       description='Res_Bi_ASQS' # Bi_ASQS  Bi_ASIS  Bi_ASCTW  Bi_QSIS  Bi_QSCTW  Bi_ISCTW
       label=[1,2]       
    if whatID in np.arange(401,438,6) or whatID in np.arange(701,738,6)or whatID in [825]:
       description='Res_Bi_ASIS'
       label=[1,6]       
    if whatID in np.arange(402,439,6) or whatID in np.arange(702,739,6)or whatID in [826]:        
       description='Res_Bi_ASCTW' 
       label=[1,3,4]       
    if whatID in np.arange(403,440,6) or whatID in np.arange(703,740,6)or whatID in [827]:          
       description='Res_Bi_QSIS' 
       label=[2,6]       
    if whatID in np.arange(404,441,6) or whatID in np.arange(704,741,6)or whatID in [828]: 
       description='Res_Bi_QSCTW' 
       label=[2,3,4]       
    if whatID in np.arange(405,442,6) or whatID in np.arange(705,742,6)or whatID in [829]:  
    ...
    if whatID in np.arange(418,424) or whatID in np.arange(718,724):
       dataset='ECG+InSe'
    if whatID in np.arange(424,430) or whatID in np.arange(724,730) or whatID in [824,830]:
       dataset='MMC'
