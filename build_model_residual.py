...
#       i = inp
       ...
       i=layers.Dropout(Var.dropout, noise_shape=(None, 1, X_train.shape[2]))(i)
       ...
       return model
#%%   
def ResNet_deep_Beta_GRU(X_train,Y_train,Var):   
...
#%%    
def ResNet_wide_Beta_GRU(X_train,Y_train,Var):   
