...
def kEras(Xfeat_test, Xfeat,y_each_patient_test, y_each_patient, selected_babies, \
...
#    y_train=repeat(y_train,34)
#    y_test=repeat(y_test,34)
...
#CALCULATE THE WEIGHTS DUE TO CLASS IMBALANCE
    ...
    model = Sequential()
    model.add(Dense(units=64, activation='relu', input_shape=(shape(X_train))))
    ...
    return resultsK,resultsF1_all,prediction,loss_and_metrics 